...
/* Hide the default drag-and-drop zone text and restructure */
div[data-testid="stFileUploaderDropzone"] {
    background: rgba(8, 18, 32, 0.5) !important;
...
/* Hide default Upload text - we use custom button */
